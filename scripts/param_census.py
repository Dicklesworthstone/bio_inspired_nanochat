...
SUBSYSTEM: dict[str, str] = {
    ...
    "glial_homeostasis": "glial_homeostasis",
    "glial_group_size": "glial_homeostasis",
    "glial_ema_rate": "glial_homeostasis",
    "glial_feedback_rate": "glial_homeostasis",
    "glial_energy_weight": "glial_homeostasis",
    "glial_bias_cap": "glial_homeostasis",
